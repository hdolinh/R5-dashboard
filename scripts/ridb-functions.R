# functions to process & enrich raw RIDB data 2018-2021
# source in `ridb-processing.R`
...
# f. calc_vars() ----
# need to calculate length of stay BEFORE cleaning site type
...
# h. calc_dist_travel() ----
calc_dist_travel <- function(sitetype_df, dist_travel_df){
